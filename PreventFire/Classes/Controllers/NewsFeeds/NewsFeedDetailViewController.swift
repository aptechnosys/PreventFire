...
class NewsFeedDetailViewController: AbstractViewController {
...
extension NewsFeedDetailViewController {
    ...
    private  func setupNavigationBar() {
        if isFromMenuView {
            ...
            setNavigationBarTitle(LocalizedStrings.newsFeedDetail)
            configureNavbarTitle(LocalizedStrings.newsFeedDetail)

        } else {
            setTransparentNavigationBar()
            setNavBarTitle(LocalizedStrings.newsFeedDetail)
            addbackButton()
        }
    }
